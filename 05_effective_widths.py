...
parser.add_argument('--out_dir', default="predicted_widths", type=str, help='Folder to save predicted widths')
...
if __name__=="__main__":
    ...
    for pred_raster_fp in tqdm(filtered_paths):
        ...
        binary_mask, intersecting_mask = get_sword_mask_intersection(
